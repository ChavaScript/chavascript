...
define("ace/mode/chavascript_worker",[], function(require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var Mirror = require("../worker/mirror").Mirror;

    var ChavaScriptWorker = exports.ChavaScriptWorker = function(sender) {
        Mirror.call(this, sender);
        this.setTimeout(500);
    };

    oop.inherits(ChavaScriptWorker, Mirror);

    (function() {

        this.onUpdate = function() {
            var value = this.doc.getValue();
            this.sender.emit("update", value);
        };

    }).call(ChavaScriptWorker.prototype);
